...
def predictRating(recommend_data):
    ...
    #        if new_job[j][x] != ' ':
    #            print(type(new_job[j][x]),new_job[j][x],end=',')
    #        else:
    #            print('**',end=',')
    #    print()
    print('---------------------------------------------------------------------------')
    job=[]
    print(type(new_job[0]),new_job[0])
    print(type(new_job[0][0]),new_job[0][0])
